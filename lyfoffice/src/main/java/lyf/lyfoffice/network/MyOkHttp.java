...
import lyf.lyfoffice.tools.JsonParser;
...
public class MyOkHttp {
     ...
     * @param handlerCode
     */
    public static void doGetJsonString(final String url, final Handler handler, final int handlerCode) {
        new Thread(){
            @Override
            public void run() {
                super.run();
