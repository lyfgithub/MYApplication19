 ...
 */
public class MyBindService3 extends Service {
    String Tag="MyBindService3";
    public MyBindService3() {
    ...
    //中间人 //暴露方法给外面
    private class MyMiddlePerson extends IMiddlePerson.Stub {
        /** 暴露的方法 */
        ...
        void MyMiddlePersonFun(){
               Toast.makeText(MyBindService3.this,"中间人私有方法！",Toast.LENGTH_SHORT).show();
        }
    }

    /** 服务中的方法  */
    private void funInService(int money){
        Log.v(Tag,"服务中的方法funInService()");
